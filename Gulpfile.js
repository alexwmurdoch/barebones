...
var concatjs = require('gulp-concat-util');
...
gulp.task('bootstrap-js', function() {
    return gulp.src([
        ...
        bowerpath+'/bootstrap/js/dist/util.js',
        bowerpath+'/bootstrap/js/dist/alert.js',
        bowerpath+'/bootstrap/js/dist/button.js',
        bowerpath+'/bootstrap/js/dist/carousel.js',
        bowerpath+'/bootstrap/js/dist/collapse.js',
        bowerpath+'/bootstrap/js/dist/dropdown.js',
        bowerpath+'/bootstrap/js/dist/modal.js',
        bowerpath+'/bootstrap/js/dist/scrollspy.js',
        bowerpath+'/bootstrap/js/dist/tab.js',
        bowerpath+'/bootstrap/js/dist/tooltip.js',
        bowerpath+'/bootstrap/js/dist/popover.js'
    ])
        .pipe(concatjs('bootstrap.js'))
        .pipe(concatjs.header('+function ($) {\n'))
        .pipe(concatjs.footer('\n}(jQuery);'))
        .pipe(gulp.dest('./_site/js/'))
...
gulp.task('build', ['clean','copy','compile-js','bootstrap-js','compile-sass','compile-html']);
